...
function renderProducts(products) {
  ...
  list.innerHTML = products.map(p => `
    <div class="bg-white rounded-lg shadow overflow-hidden flex flex-col" style="min-height: 320px;">
      <a href="items.html?id=${p._id || p.id}" class="block h-40 sm:h-48 w-full overflow-hidden">
      ...
      <div class="p-3 flex-1 flex flex-col justify-between">
        ...
        <div>
          ...
          <div class="flex gap-2 mt-3">
            <a href="items.html?id=${p._id || p.id}" class="flex-1 px-2 py-1 bg-blue-600 text-white rounded-lg hover:bg-blue-700 text-center text-xs">View</a>
